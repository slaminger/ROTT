...
function sources_mupen64plus() {
    ...
    local repos=(
        "mupen64plus core master ef15526"
        'mupen64plus ui-console master 5926250'
        'mupen64plus audio-sdl master 732722c'
        'mupen64plus input-sdl master f5c3995'
        'mupen64plus rsp-hle master 1233981'
        'ricrpi video-gles2n64 master aef5b17'
        'mupen64plus video-glide64mk2 master 1408ef1'
        'ricrpi video-gles2rice pandora-backport 03189cb'
    )
